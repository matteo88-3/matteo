                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-10 rounded-3xl shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-transform duration-300 border border-slate-100">
                            ...
                            <p className="text-slate-600 mb-6 leading-relaxed">Delivering high-impact talks globally, focused on fintech innovation, talent transformation, and ecosystem building across Europe, Africa, and beyond.</p>
                            <button  className="text-primary font-semibold hover:text-secondary flex items-center gap-2">Book Matteo <i className="fa-solid fa-arrow-right"></i></button>
                        </div>
                        <div className="bg-secondary text-white p-10 rounded-3xl shadow-xl shadow-slate-900/20 hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
                            ...
                            <button className="text-primary font-semibold hover:text-white flex items-center gap-2">Work With Me <i className="fa-solid fa-arrow-right"></i></button>
                        </div>
                        <div className="bg-white p-10 rounded-3xl shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-transform duration-300 border border-slate-100">
                            <div className="w-16 h-16 bg-blue-50 text-primary rounded-2xl flex items-center justify-center text-2xl mb-6">
                                <Network />
                            ...
                            <button  className="text-primary font-semibold hover:text-secondary flex items-center gap-2">Explore Ecosystems <i className="fa-solid fa-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            </section>
